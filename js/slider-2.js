...
iconChevronRight.addEventListener("click", function(){
    ...
    else if (boxCarousel.classList.contains("box-carousel-6")) {
        boxCarousel.classList.remove("box-carousel-6");
        boxCarousel.classList.add("box-carousel-7");
    }
    else if (boxCarousel.classList.contains("box-carousel-7")) {
        boxCarousel.classList.remove("box-carousel-7");
        boxCarousel.classList.add("box-carousel-8");
    }
    else if (boxCarousel.classList.contains("box-carousel-8")) {
        boxCarousel.classList.remove("box-carousel-8");
        boxCarousel.classList.add("box-carousel-9");
    }
    else if (boxCarousel.classList.contains("box-carousel-9")) {
        boxCarousel.classList.remove("box-carousel-9");
...
iconChevronLeft.addEventListener("click", function(){
    ...
    else if (boxCarousel.classList.contains("box-carousel-1")) {
        boxCarousel.classList.remove("box-carousel-1");
        boxCarousel.classList.add("box-carousel-9");
    }
});
